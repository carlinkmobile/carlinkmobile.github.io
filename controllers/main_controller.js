angular.module('project').controller('MainController', ['$scope', '$resource', '$http', 'Pubnub', function($scope, $resource, $http, Pubnub) {
    Pubnub.init({
        publishKey: 'pub-c-c843bf56-1c26-442d-9601-b0822ebec54e',
        subscribeKey: 'sub-c-7fbc0790-e5d5-11e7-9f1e-625d8ea2b1bc'
    });
...
// angular.module('project').controller('MainController', function($scope, $resource, $http, 'Pubnub') {
//     Pubnub.init({
//         publishKey: 'pub-c-c843bf56-1c26-442d-9601-b0822ebec54e',
//         subscribeKey: 'sub-c-7fbc0790-e5d5-11e7-9f1e-625d8ea2b1bc'
//     });
